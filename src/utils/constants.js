...
export const ATTEMPT_FEEDBACK_SHIP_HIT = 'ATTEMPT_FEEDBACK_SHIP_HIT';
export const ATTEMPT_FEEDBACK_SHIP_DESTROYED = 'ATTEMPT_FEEDBACK_SHIP_DESTROYED';
export const ATTEMPT_FEEDBACK_SHOT_MISSED = 'ATTEMPT_FEEDBACK_SHOT_MISSED';
